...
console.log(headerbarsTb);
headerIconSearch.addEventListener("click", (e) => {
  headerContainer.classList.toggle("is-noneForm");
  headerbarsMb.classList.toggle("is-noneForm");
  headerbarsTb.classList.toggle("is-noneForm");
...
menuTableIcon.addEventListener("click", (e) => {
  ...
  wrapperTable.classList.toggle("is-showLeftTB");
  headerTable.classList.toggle("is-showLeftTB");
...
window.addEventListener("scroll", () => {
  ...
  if (scrollY >= 100) {
    ...
    formIconClose.style.color = "#000";
    headerIconBars.style.borderColor = "#e1e1e1";
    headerTbImg.style.color = "#000";
    headerMbImg.style.color = "#000";
  } else {
    ...
    formIconClose.style.color = "#fff"
    headerTbImg.style.color = "#fff";
    headerMbImg.style.color = "#fff";
  }
});
